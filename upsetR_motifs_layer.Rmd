---
title: "Linage-specific motifs by the UpSetR. We find Enh DAR DMRs intersection of motifs within each Layer: show how similar motifs are for regions of the same lineage, and how different they are between lineages"
output:
...
```
-read motifs Excel files: Enhancers, DMRs, DARs

-read motifs  Enhancers
...
```
-make individual motif lists for DMRs: get the functions first
